package net.kzn.hobbypedia.controller;
...
import net.kzn.hobbypedia.util.FileUtil;
import net.kzn.hobbypedia.validator.ProductValidator;
import net.kzn.hobbypediabackend.dao.CategoryDAO;
import net.kzn.hobbypediabackend.dao.ProductDAO;
import net.kzn.hobbypediabackend.dto.Category;
import net.kzn.hobbypediabackend.dto.Product;
...
public class ManagementController {
	...
	public ModelAndView manageProduct(@RequestParam(name="success",required=false)String success) {		
		...
		if(success != null) {
			if(success.equals("product")){
				mv.addObject("message", "Hobby submitted successfully!");
			}	
	...
	public String managePostProduct(@Valid @ModelAttribute("product") Product mProduct, 
		...
		if(results.hasErrors()) {
			model.addAttribute("message", "Validation fails for adding !");
	...
	public String managePostProductActivation(@PathVariable int id) {		
		...
		return (isActive)? "Hobby Dectivated Successfully!": "Hobby Activated Successfully";
	}

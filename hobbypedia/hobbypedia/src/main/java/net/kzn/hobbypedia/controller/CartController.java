...
import net.kzn.hobbypedia.service.CartService;
...
public class CartController {
	...
	public ModelAndView showCart(@RequestParam(name = "result", required = false) String result) {
		...
		if(result!=null) {
			switch(result) {
				case "added":
					mv.addObject("message", "Hobby has been successfully added!");					
					cartService.validateCartLine();
					break;
				case "unavailable":
					mv.addObject("message", "It is not available!");					
					break;
				case "updated":
					...
					break;
				case "modified":
					mv.addObject("message", "One or more items inside has been modified!");
					break;
				case "maximum":

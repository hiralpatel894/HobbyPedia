...
<title>HobbyPedia - Membership</title>
	...
	<div class="content">
		<div class="container">
		    						...
		    						<tbody>
		    							...
		    							<c:forEach items="${orderDetail.orderItems}" var="orderItem">
			    							<tr>
			    								...
			    								<td class="text-center">CAD ${orderItem.buyingPrice}</td>
			    								<td class="text-center">${orderItem.productCount}</td>
			    								<td class="text-right">CAD ${orderItem.total}</td>
			    							</tr>
		    							</c:forEach>
		    						</tbody>
		    					</table>
		    ...
		    <div class="text-center">
		    	<a href="${contextRoot}/show/all/hobbies" class="btn btn-lg btn-warning">Continue Explore</a>
		    </div>
		</div>

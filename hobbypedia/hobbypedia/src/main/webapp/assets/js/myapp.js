					...
					columns : [
							...
							},
							{
								...
								mRender : function(data, type, row) {
									...
									if(userRole !== 'ADMIN') {
										if (row.quantity < 1) {
											str += '<a href="javascript:void(0)" class="btn btn-danger disabled"><span class="glyphicon glyphicon-heart"></span></a>';
										} else {
											...
											str += '<a href="'
													...
													+ '/cart/add/'
													+ data
													+ '/product" class="btn btn-danger"><span class="glyphicon glyphicon-heart"></span></a>';
										}
									}
									else {
										str += '<a href="'
		...
		$productsTable.DataTable({
					...
					initComplete: function () {
						...
						api.$('.switch input[type="checkbox"]').on('change' , function() {							
							var dText = (this.checked)? 'You want to activate the Hobby?': 'You want to de-activate the Hobby?';
